...
public class OTPVerification extends AppCompatActivity {
    ...
    private void callVerifyOtp() {
        ...
        Call<VerifyOTPResponse> call = RetrofitClient
                .getInstance().getApi().verifyOtp(SaveObject.getInstance().getApiKey(), SaveObject.getInstance().getMobile(), otp.getText().toString(),SaveObject.getInstance().getAccountNo(),SaveObject.getInstance().getAccountProvider());
